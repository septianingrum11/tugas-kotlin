 ...
 */
fun myProfile() {
    var NamaDepan : String = "Dian"
    var NamaBelakang : String = "Septianingrum"
    var Umur : Int = 25
 ...
 *
 */
fun myName(args: String) {
    val Group3 = arrayOf<String>("Septi","Anshari","Fajar","Fillah","Ega")
...
fun main() {
     ...
     *
     */
    groupDetail(3, listOf("Septi", "Fillah","Anshari","Ega","Fajar"), "Morning")
